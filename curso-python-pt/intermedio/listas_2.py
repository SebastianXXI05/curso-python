'''
listas_1.py
script en Python que calcula y muestra la suma de dos matrices cuadradas (misma cantidad de renglones y
columnas) generadas aleatoriamente. Utilizarcomprension de listas para generar las matrices de forma aleatoria.
'''
import random
